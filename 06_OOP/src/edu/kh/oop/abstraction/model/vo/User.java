...
public class User {
	...
	// 데이터 직접 접근 불가 원칙 -> 필드는 기본적으로 모두 privat(캡슐화 진행)
	...
	// ** 매개변수 : 생성자나 메서드 호출 시 () 안에 작성되어 전달되어지는
	//값을 저장하고 있는 변수
	...
	//public User() {} // 기본 생성자가 이미 작성되어있어서 X
	...
	public User(String userId, int userAge) {} //매개변수의 개수와
	//동일한 것이 있으나 하나의 타입이 다름
	// -> 오버로딩 성립
	...
	// toString() 메서드 : objec 최상위 클래스 미이 만들어져있는
	//메서드 객체가 문자열로 반환될 때 호출되는 메서드

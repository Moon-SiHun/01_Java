...
public class SetService {
	 ...
	 * 2. LingkedHashset : 순서를 유지하는 Set
	 * 3. TreeSet : 자동 정렬된 Set
	 */
	 ...
	 * -> Interger 는 Comparable 상속 되어있음
	 * 
	 */
	public void method4() {
		
		// Integer를 저장할 TreeSet
	...
	public void lottoNumberGenerator() {
		...
		// 생성된 로또 번호 묶음(TreeSet)을 저정할 List 객체 생성

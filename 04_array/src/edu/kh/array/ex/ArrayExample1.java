...
public class ArrayExample1 {
	 ...
	 *    구분은 index 이용함 ( index 0부터 시작하는 정수)
	 *    
	 */
	...
	public void ex2() {
		...
		//  컴파일 에러 : 컴파일 단계에서 생기는 에러(코드에서 빨간줄 에러)
		// 런타임 에러 : 실행했을 때 발생하는 에러
	...
	public void ex3() {
		...
		// double[] 자료형 창조변수 height를 stack 영역에 생성하고
		// height에 heap 영역에 새로 생성된 double 5칸짜리 배열의 조술 대입
	...
	public void ex4() {
		// 입력 받은 인원 수만큼의 정수를 입력받아 배열에 저장
		// 입력이 안료되면 점수 합계, 평균, 최고잠, 최저점 출력
	...
	public void ex6() {
		...
		// -> ! (Not 연산자 : 부정 논리 연산자)를 붙여줌으로써 true로 변경하여
		// {} 안에 있는 코드를 수행하게끔 함
	...
	public void ex9() {
		...
		// sc.next() -> String형
		// String.charAt(0) -> String의 0번째 문자 하나를 추출해서 char 형태로 반환
		// "h" -> 'h'
